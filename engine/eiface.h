...
typedef struct 
{
	...
	void			(*pfnCreateBaseline) ( int player, int eindex, struct entity_state_s *baseline, struct edict_s *entity, int playermodelindex, const Vector& player_mins, const Vector& player_maxs );
