...
void CHudStatusIcons::EnableIcon( const char* const pszIconName, unsigned char red, unsigned char green, unsigned char blue )
{
	int i;
...
void CHudStatusIcons::DisableIcon( const char* const pszIconName )
{
