...
*
****/
#ifndef GAME_CLIENT_EXPORTS_H
#define GAME_CLIENT_EXPORTS_H

//CL_DLLEXPORT has been replaced with DLLEXPORT. Secure clients have been obsolete for a long time. - Solokiller

/**
*	@defgroup ClientLibExports Client Lib Exports
*
*	See cldll_func_t for the documentation for these functions. - Solokiller
*	@see cldll_func_t
*
*	@{
*/
