...
{
	return studio::CalcBoneAdj( m_pStudioHeader, dadt, adj, pcontroller1, pcontroller2, mouthopen );
}
...
{
	studio::CalcBoneQuaterion( frame, s, pbone, panim, adj, q );
}
...
{
	studio::CalcBonePosition( frame, s, pbone, panim, adj, vecPos );
}
...
{
	studio::SlerpBones( m_pStudioHeader, q1, vecPos1, q2, vecPos2, s );
}
...
{
	studio::CalcRotations(
		m_pStudioHeader, 
		vecPos, q, pseqdesc, panim, f, 
		StudioEstimateInterpolant(), 
		m_pCurrentEntity->curstate.controller, 
