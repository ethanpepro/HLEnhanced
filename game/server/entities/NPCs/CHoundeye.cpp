...
void CHoundeye :: HandleAnimEvent( AnimEvent_t& event )
{
	switch ( event.event )
	{
		...
		case HOUND_AE_ANGERSOUND1:
			EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_pain3.wav", 1, ATTN_NORM);
			break;

		case HOUND_AE_ANGERSOUND2:
			EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_pain1.wav", 1, ATTN_NORM);
			break;
...
void CHoundeye :: IdleSound ( void )
{
	...
	{
	case 0:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_idle1.wav", 1, ATTN_NORM );
		break;
	case 1:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_idle2.wav", 1, ATTN_NORM );
		break;
	case 2:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_idle3.wav", 1, ATTN_NORM );
		break;
	}
}
...
void CHoundeye :: WarmUpSound ( void )
{
	...
	{
	case 0:
		EMIT_SOUND( this, CHAN_WEAPON, "houndeye/he_attack1.wav", 0.7, ATTN_NORM );
		break;
	case 1:
		EMIT_SOUND( this, CHAN_WEAPON, "houndeye/he_attack3.wav", 0.7, ATTN_NORM );
		break;
	}
}
...
void CHoundeye :: WarnSound ( void )
{
	...
	{
	case 0:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_hunt1.wav", 1, ATTN_NORM );
		break;
	case 1:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_hunt2.wav", 1, ATTN_NORM );
		break;
	case 2:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_hunt3.wav", 1, ATTN_NORM );
		break;
	}
}
...
void CHoundeye :: AlertSound ( void )
{
	...
	{
	case 0:	
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_alert1.wav", 1, ATTN_NORM );
		break;
	case 1:	
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_alert2.wav", 1, ATTN_NORM );
		break;
	case 2:	
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_alert3.wav", 1, ATTN_NORM );
		break;
	}
}
...
void CHoundeye :: DeathSound ( void )
{
	...
	{
	case 0:	
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_die1.wav", 1, ATTN_NORM );
		break;
	case 1:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_die2.wav", 1, ATTN_NORM );
		break;
	case 2:
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_die3.wav", 1, ATTN_NORM );
		break;
	}
}
...
void CHoundeye :: PainSound ( void )
{
	...
	case 0:	
		...
		break;
	case 1:	
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_pain4.wav", 1, ATTN_NORM );
		break;
	case 2:	
		EMIT_SOUND( this, CHAN_VOICE, "houndeye/he_pain5.wav", 1, ATTN_NORM );
		break;
	}
}
...
void CHoundeye :: SonicAttack ( void )
{
	...
	switch ( RANDOM_LONG( 0, 2 ) )
	{
	case 0:	EMIT_SOUND(this, CHAN_WEAPON, "houndeye/he_blast1.wav", 1, ATTN_NORM);	break;
	case 1:	EMIT_SOUND(this, CHAN_WEAPON, "houndeye/he_blast2.wav", 1, ATTN_NORM);	break;
	case 2:	EMIT_SOUND(this, CHAN_WEAPON, "houndeye/he_blast3.wav", 1, ATTN_NORM);	break;
	}
